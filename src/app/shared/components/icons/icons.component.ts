...
@Component({
  ...
  template: `
    @switch (name) {
      @case ('menu') {
        <svg [class]="className" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
      ...
      @case ('facebook') {
        <svg [class]="className" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
